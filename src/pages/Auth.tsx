      ...
      <Card className="w-full max-w-md relative z-10 bg-card/80 backdrop-blur-xl border-border/50">
        ...
        <CardContent>
          ...
          <Button 
            ...
            disabled={isLoading}
            className="w-full mb-3 bg-white hover:bg-gray-100 text-gray-900 border border-gray-300"
          >
          ...
          <Button 
            ...
            disabled={isLoading}
            className="w-full mb-6 bg-black hover:bg-gray-900 text-white border border-gray-700"
          >
