...
const GlobalAudioPlayer = () => {
  ...
  return (
    <>
      <div 
        className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-xl border-t border-white/10 z-50 safe-area-pb cursor-pointer"
        onClick={(e) => {
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-4">
          ...
          <div className="flex items-center gap-4 flex-1 justify-end">
            ...
            <div className="items-center gap-2 hidden md:flex" onClick={(e) => e.stopPropagation()}>
              <Button 
                variant="ghost" 
                size="icon"
