  ...
  public: {
    Tables: {
      ...
      radio_chats: {
        ...
        Relationships: [
          {
            foreignKeyName: "radio_chats_station_id_fkey"
            columns: ["station_id"]
            isOneToOne: false
      ...
      radio_gifts: {
        ...
        Relationships: [
          {
            foreignKeyName: "radio_gifts_station_id_fkey"
            columns: ["station_id"]
            isOneToOne: false
            referencedRelation: "radio_stations"
            referencedColumns: ["id"]
      ...
      radio_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "radio_subscriptions_station_id_fkey"
            columns: ["station_id"]
            isOneToOne: false
            referencedRelation: "radio_stations"
            referencedColumns: ["id"]
