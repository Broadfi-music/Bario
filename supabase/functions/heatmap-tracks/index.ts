...
const countryArtists: Record<string, string[]> = {
  ...
  'IN': ['Arijit Singh', 'Diljit Dosanjh', 'AP Dhillon', 'Badshah', 'Divine', 'Raftaar', 'Karan Aujla', 'Shreya Ghoshal', 'Anirudh Ravichander', 'Sid Sriram', 'A.R. Rahman', 'Yuvan Shankar Raja', 'Dhanush', 'GV Prakash Kumar', 'Jonita Gandhi', 'Chinmayi', 'SPB', 'Ilaiyaraaja', 'Hip Hop Tamizha', 'Pradeep Kumar', 'Sean Roldan', 'Santhosh Narayanan', 'D. Imman', 'Haricharan', 'Armaan Malik', 'Darshan Raval', 'Jubin Nautiyal', 'Neha Kakkar', 'King', 'MC Stan', 'Seedhe Maut', 'Hanumankind'],
...
const countryTrendingQueries: Record<string, string[]> = {
  ...
  'IN': ['bollywood 2025', 'tamil songs 2025', 'kollywood music new', 'south indian songs 2025', 'indian hip hop 2025', 'punjabi music 2025'],
...
serve(async (req) => {
  ...
  try {
    ...
    // Sort by attention score from streaming platform data — rankings reflect real platform performance
